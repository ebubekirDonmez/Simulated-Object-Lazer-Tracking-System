...
cd repo-name
Update Paths in lazers.py: Open the script and locate the following lines to update them with your absolute paths:
...
Camera Indexing: Check your camera ports. The script uses index 0 and 2 by default. Change them if necessary:
